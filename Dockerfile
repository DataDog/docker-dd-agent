...
ENV DOCKER_DD_AGENT=yes \
    AGENT_VERSION=1:5.14.0-1

# Install the Agent
ADD https://1927-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.14.0.git.4.677f604-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.14.0.git.4.677f604-1_amd64.deb && rm /datadog-agent_5.14.0.git.4.677f604-1_amd64.deb
