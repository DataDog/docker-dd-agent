...
# Install the Agent
ADD https://1302-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.10.0.git.50.38476d5-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.10.0.git.50.38476d5-1_amd64.deb && rm /datadog-agent_5.10.0.git.50.38476d5-1_amd64.deb
