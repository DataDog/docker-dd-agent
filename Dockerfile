...
# Install the Agent
ADD https://circle-artifacts.com/gh/DataDog/docker-dd-agent-build-deb-x64/976/artifacts/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.8.0.git.22.32bf58e-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.8.0.git.22.32bf58e-1_amd64.deb && rm /datadog-agent_5.8.0.git.22.32bf58e-1_amd64.deb
